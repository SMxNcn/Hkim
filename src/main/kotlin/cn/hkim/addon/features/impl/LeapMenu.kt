...
object LeapMenu : Module("Leap Menu", "Custom leap menu.") {
    ...
    private val topLeftKeybind by KeybindSetting("Top Left", "Used to click on the first person in the leap menu.", SDLScancode.SDL_SCANCODE_UNKNOWN).depends { keybindType == 0 }
    private val topRightKeybind by KeybindSetting("Top Right", "Used to click on the second person in the leap menu.", SDLScancode.SDL_SCANCODE_UNKNOWN).depends { keybindType == 0 }
    private val bottomLeftKeybind by KeybindSetting("Bottom Left", "Used to click on the third person in the leap menu.", SDLScancode.SDL_SCANCODE_UNKNOWN).depends { keybindType == 0 }
    private val bottomRightKeybind by KeybindSetting("Bottom Right", "Used to click on the fourth person in the leap menu.", SDLScancode.SDL_SCANCODE_UNKNOWN).depends { keybindType == 0 }

    private val archerKeybind by KeybindSetting("Archer", "Used to leap to the Archer in the leap menu.", SDLScancode.SDL_SCANCODE_UNKNOWN).depends { keybindType == 1 }
    private val berserkKeybind by KeybindSetting("Berserker", "Used to leap to the Berserker in the leap menu.", SDLScancode.SDL_SCANCODE_UNKNOWN).depends { keybindType == 1 }
    private val healerKeybind by KeybindSetting("Healer", "Used to leap to the Healer in the leap menu.", SDLScancode.SDL_SCANCODE_UNKNOWN).depends { keybindType == 1 }
    private val mageKeybind by KeybindSetting("Mage", "Used to leap to the Mage in the leap menu.", SDLScancode.SDL_SCANCODE_UNKNOWN).depends { keybindType == 1 }
    private val tankKeybind by KeybindSetting("Tank", "Used to leap to the Tank in the leap menu.", SDLScancode.SDL_SCANCODE_UNKNOWN).depends { keybindType == 1 }
