...
object CommandKeybinds : Module("Command Keybinds", "Various keybinds for skyblock commands.") {
    ...
    private val loadouts by KeybindSetting("Loadouts", "Opens the loadouts menu.")
