...
object FarmingHelper : Module("Farming Helper", "Features for garden farming.") {
    ...
    private val nukerKeybind by KeybindSetting("Nuker Keybind", "Keybind to toggle nuker.", InputConstants.KEY_X)
    ...
    private fun onMouseClick(event: MouseButtonEvent) {
        ...
        if (!allowEdits || event.button != InputConstants.MOUSE_BUTTON_RIGHT) return
