...
class ClickGUIScreen(private val parent: Screen?) : Screen(Component.literal("Click GUI")) {
    ...
    override fun extractRenderState(graphics: GuiGraphicsExtractor, mouseX: Int, mouseY: Int, delta: Float) {
        ...
        graphics.drawRoundedRectWithBorder(guiX, guiY, guiW, guiH, 0x801A1A1A.toInt(), 0xFF444444.toInt(), 1f, 8f)
    ...
    private fun renderHeader(graphics: GuiGraphicsExtractor, mouseX: Int, mouseY: Int, delta: Float) {
        ...
        graphics.drawHorizontalSeparator(x + 8f, y + h - 1, w - 16f, 0xFF333333.toInt())
        ...
        graphics.drawRoundedRectWithBorder(sbX, sbY, sbW, sbH, 0x002A2A2A, 0xFF555555.toInt(), 1f, 4f)
        ...
        val closeX = x + w - 32f
        graphics.drawRoundedRectWithBorder(closeX, sbY, 20f, 20f, 0xFF3A2A2A.toInt(), 0xFFAA4444.toInt(), 1f, 4f)
