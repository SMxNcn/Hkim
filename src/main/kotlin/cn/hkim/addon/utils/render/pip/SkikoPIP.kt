...
class SkikoPIP : PictureInPictureRenderer<SkikoPIP.SkikoRenderState>() {
    ...
    override fun renderToTexture(state: SkikoRenderState, poseStack: PoseStack, submitNodeCollector: SubmitNodeCollector) = Unit
