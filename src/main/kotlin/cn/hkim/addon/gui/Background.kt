...
object Background {
    ...
    private const val BG_URL = "https://gitee.com/mixturedg/hkim-repo/raw/master/bg/bg0.png"
    ...
    fun renderVanillaPanorama(graphics: GuiGraphicsExtractor, screen: Screen) {
        ...
        mc.gameRenderer.panorama().extractRenderState(graphics, screen.width, screen.height)
